...
document.querySelector('.three').innerHTML = '<h3>Poltava</h3>';
...
task11.innerHTML += '<h4>Vinga</h4>';
task11.innerHTML += '<p>Poltava</p>';
...
let x1 = 'Hello', x2 = 5;
document.querySelector('.intel').innerHTML = x1 + x2;// происходит преобразование циры в строку
...
console.log(d1);// переменная отвечает за данный блок
...
console.log(d2);
d2 = 5;
console.log(d2);//просто переназначил нвое содержимое для переменной
...
console.log(divS3);// у переменнной переназначились поочередно блоки
// Task 20
...
// document.querySelector('body').innerHTML = ''; // обнулил body